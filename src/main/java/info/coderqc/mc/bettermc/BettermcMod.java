 ...
 *
 */
package info.coderqc.mc.bettermc;
...
import info.coderqc.mc.bettermc.init.BettermcModMobEffects;
...
public class BettermcMod {
	public static final Logger LOGGER = LogManager.getLogger(BettermcMod.class);
	public static final String MODID = "bettermc";
	...
	public BettermcMod() {
		...
		BettermcModMobEffects.REGISTRY.register(bus);
