...
public abstract class AcidFluid extends ForgeFlowingFluid {
	public static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(() -> BettermcModFluidTypes.ACID_TYPE.get(),
			() -> BettermcModFluids.ACID.get(), () -> BettermcModFluids.FLOWING_ACID.get()).explosionResistance(100f)
			.bucket(() -> BettermcModItems.ACID_BUCKET.get()).block(() -> (LiquidBlock) BettermcModBlocks.ACID.get());
