...
public class AcidFeature extends LakeFeature {
	public static AcidFeature FEATURE = null;
	public static Holder<ConfiguredFeature<LakeFeature.Configuration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new AcidFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("bettermc:acid", FEATURE,
				new LakeFeature.Configuration(BlockStateProvider.simple(BettermcModBlocks.ACID.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("bettermc:acid", CONFIGURED_FEATURE,
